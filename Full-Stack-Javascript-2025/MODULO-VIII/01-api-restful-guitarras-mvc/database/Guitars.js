...
export const createNewGuitarDB = (newGuitar) => {
...
// PUT
export const replaceOneGuitarDB = ( guitarId, guitarData ) => {
...
export const patchOneGuitarDB = ( guitarId, changes ) => {
     const index = getIndexById(guitarId)
...
export const deleteOneGuitarDB = (guitarId) => {
    const index = getIndexById(guitarId)
    if(index === -1)  throw new ApiError(404, `No existe una guitarra con el id '${guitarId}'.`) 
