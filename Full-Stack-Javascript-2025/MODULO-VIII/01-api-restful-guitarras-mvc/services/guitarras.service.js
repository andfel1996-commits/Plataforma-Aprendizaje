...
export const createNewGuitarService = ( newGuitar ) => {
    const guitarToInsert = {
        id : uuidv4().split('-')[0],
        ...newGuitar,
        createdAt: new Date().toISOString()
    }
    return createNewGuitarDB(guitarToInsert)
}

// PUT /api/v1/guitarras/:id
export const replaceOneGuitarService = ( guitarId, guitarData ) => {
    return replaceOneGuitarDB( guitarId, guitarData )
}

// PATCH /api/v1/guitarras/:id
export const patchOneGuitarService = ( guitarId, changes ) => {
    return patchOneGuitarDB(guitarId, changes)
}

// DELETE /api/v1/guitarras/:id
export const deleteOneGuitarService = ( guitarId ) => {
    deleteOneGuitarDB( guitarId )
}